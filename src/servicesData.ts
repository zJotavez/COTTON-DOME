...
export const SERVICES_DATA: ServiceDetails[] = [
  ...
  },
  {
    ...
    shortDescription: "Proteção perimetral e interna com sensores de movimento avançados, sirenes de alta potência e centrais conectadas.",
  ...
  },
  {
    ...
    shortDescription: "Leitores inteligentes, fechaduras eletrónicas e torniquetes para garantir que apenas pessoas autorizadas acedem ao seu espaço.",
    description: "Fornecemos e instalamos sistemas avançados de controlo de acessos residenciais e corporativos. Permita a entrada controlada de funcionários, visitantes ou residentes com leitores de impressão digital, reconhecimento facial em frações de segundo, tags, cartões de proximidade ou códigos numéricos, mantendo um registo histórico em tempo real e integração com alarmes e CCTV.",
